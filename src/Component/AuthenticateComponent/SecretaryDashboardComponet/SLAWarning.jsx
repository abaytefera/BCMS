...
//     'complete meeting':'bg-gradient-to-br from-blue-400 via-blue-500 to-indigo-500 text-white',
//     'schedule meeting': 'bg-gradient-to-br from-purple-400 via-purple-500 to-indigo-600 text-white',
//     'today meeting': 'bg-gradient-to-br from-red-500 via-red-600 to-orange-500 text-white shadow-lg shadow-red-200',
//     'approve': ' bg-gradient-to-br from-emerald-400 via-emerald-500 to-teal-500 text-white'
